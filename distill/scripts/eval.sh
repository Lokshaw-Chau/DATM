...
--dataset=CIFAR100 \
--model=ConvNetD3 \
--lr_dir=/root/workspace/DATM/distill/logged_files/CIFAR100/1/ConvNetD3/exp123_tesla/Normal/lr_best.pt \
--data_dir=/root/workspace/DATM/distill/logged_files/CIFAR100/1/ConvNetD3/exp123_tesla/Normal/images_best.pt \
--label_dir=/root/workspace/DATM/distill/logged_files/CIFAR100/1/ConvNetD3/exp123_tesla/Normal/labels_best.pt --zca \
--eval_mode=Avg
