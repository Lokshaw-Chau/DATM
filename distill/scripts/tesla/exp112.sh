...
CUDA_VISIBLE_DEVICES=2 python /root/workspace/DATM/distill/DATM_tesla_picaug.py --cfg /root/workspace/DATM/configs/CIFAR-100/ConvIN_PicAug/IPC1-1-1-2.yaml